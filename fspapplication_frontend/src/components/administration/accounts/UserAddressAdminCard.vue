<template>
  <ComponentCard title="Address Information">
    ...
    <div v-else class="relative">
      ...
      <div v-if="userData?.profile" class="grid grid-cols-1 md:grid-cols-2 gap-6 pt-2">
        <!-- Street Address -->
        <div class="space-y-2">
          <p class="text-sm text-gray-500 dark:text-gray-400">Street Address</p>
          <p class="font-medium text-black dark:text-white">
            {{ formatStreetAddress(userData.profile) }}
          </p>
        </div>
        ...
        <div class="space-y-2">
          ...
          <p class="font-medium text-black dark:text-white">
            {{ userData.profile.suburb || userData.profile.city || 'Not provided' }}
          </p>
        </div>
        ...
        <div class="space-y-2">
          ...
          <p class="font-medium text-black dark:text-white">
            {{ userData.profile.postalCode || 'Not provided' }}
          </p>
        </div>
