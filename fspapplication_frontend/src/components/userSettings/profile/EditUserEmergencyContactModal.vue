...
const emit = defineEmits<{
  (e: 'close'): void;
  (e: 'save', data: Partial<ProfileData>): void;
}>();

// Create a form data object from user data props
const formData = ref<Partial<ProfileData>>({
  emergencyContact: props.userData.emergencyContact || '',
  emergencyContactFirstName: props.userData.emergencyContactFirstName || '',
