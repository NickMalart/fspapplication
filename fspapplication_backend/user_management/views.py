            ...
            if serializer.is_valid():
                try:
                    ...
                    if 'violates not-null constraint' in str(e):
                        ...
                        profile_type = None
                        # Check the actual model names/tables now in user_management
                        if 'user_management_clientprofile' in str(e): # Adjusted table name
                            profile_type = 'client_profile'
                        elif 'user_management_agentprofile' in str(e): # Adjusted table name
                            profile_type = 'agent_profile'
                        elif 'user_management_employeeprofile' in str(e): # Adjusted table name
